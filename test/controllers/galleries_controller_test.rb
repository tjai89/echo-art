...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { image_description: @gallery.image_description, image_title: @gallery.image_title } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { image_description: @gallery.image_description, image_title: @gallery.image_title } }
